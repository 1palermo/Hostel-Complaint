...
export default async function searchParams({ searchParams ,} : {
   searchParams: {_id:string; date: string; time: string; problem: string; title: string; description: string; department: string; attended: string; solved: string; close:string};
}){
